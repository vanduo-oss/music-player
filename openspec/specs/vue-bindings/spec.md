...
Optional Vue 3 component for the music player, shipped at `@vanduo-oss/music-player/vue`. The core package stays framework-agnostic; these bindings are additive.
